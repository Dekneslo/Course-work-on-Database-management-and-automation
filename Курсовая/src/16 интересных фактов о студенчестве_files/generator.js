!function() {
    ...
    !function(i) {
        ...
        return n.createInput({
            ...
            createHTML: function(t, n) {
                ...
                case"url":
                    ...
                    break;
                case"date":
                    e(".m365-input-text", i).attr("type", "date"), e(".m365-input-text", i).attr("autocomplete", "off")
                }
                return i
            }
        })
        ...
        var o = {}, r = '    <div class="m365-embeded"><noindex>         <div class="m365-form-content">            <div class="m365-logo-container"></div>            <div class="m365-title"></div>            <div class="m365-description"></div>            <div class="m365-form-groups"></div>            <div class="m365-btn-container">                <input type="submit" class="m365-btn m365-subscribe" value="">            </div>            <div class="m365-form-message">                <div class="m365-title"></div>                <div class="m365-description"></div>            </div>            <div class="m365-close-icon"></div>         </div><div class="m365-fz152"><span class="m365-fz152-text">Нажимая на кнопку, вы даете согласие на обработку своих персональных данных согласно 152-ФЗ.</span> <a href="#" class="m365-fz152-policy" target="_blank"><span class="m365-fz152-text-more">Подробнее</span></a></div>     </noindex></div>', l = i.extend({
            templateHtml: r,
